...
Original file is located at
    https://colab.research.google.com/drive/1wdrD5qu_jOtlP9IfFSfvlnp01eA96xN8
"""
...
def get_sentences():
    ...
    #each sentence is represented as a list of individual stringn tokens
    return brown.sents()
