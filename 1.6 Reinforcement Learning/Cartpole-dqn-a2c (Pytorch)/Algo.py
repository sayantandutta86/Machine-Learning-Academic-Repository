...
class DQN:
    ...
    def train(self):
        ...
        #take next_q_values1.max --> state values from learning network
        ...
        #loss = self.loss_func(q_values, target_q_values)  # Hint: try using q_values, target_q_values
...
class ActorCritic:
    ...
    def train(self):
        ...
        policy_loss = (dist.log_prob(actions) * advantage_detach)
